// Hardcoded scientist banter for the loading screen. No backend calls.
...
const ALZ: BanterLine[] = [
  ...
  { speaker: "watson", text: "Pulling neuroinflammation pathways now. Wiring up the causal graph." },
